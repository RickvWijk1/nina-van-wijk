...
echo \sprintf(
    ...
    \__('Add the (absolute or relative) URLs that you want to include in this publication.<br>%s', 'staatic'),
...
echo \sprintf(
    ...
    \__('Add the (filesystem) paths that you want to include in this publication.<br>Base path: <code>%s</code>', 'staatic'),
    $rootPath
);
?></p>
        </fieldset>
