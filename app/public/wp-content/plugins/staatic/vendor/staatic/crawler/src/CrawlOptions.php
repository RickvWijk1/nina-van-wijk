...
final class CrawlOptions
{
     ...
     * @var bool
     */
    private $urlContextEnabled = \false;
    /**
    ...
    public function __construct(array $options = [])
    {
        ...
        if (isset($options['urlContextEnabled'])) {
            $this->setUrlContextEnabled($options['urlContextEnabled']);
        }
    ...
    public function setUrlContextEnabled(bool $urlContextEnabled) : self
    {
        $this->urlContextEnabled = $urlContextEnabled;
        return $this;
    }
    public function urlContextEnabled() : bool
    {
